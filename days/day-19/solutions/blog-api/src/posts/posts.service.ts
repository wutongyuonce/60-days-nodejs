...
export class PostsService {
  ...
  constructor() {
    this.create({
      title: 'Hello Exception',
      slug: 'hello-exception',
      content: '一篇用来演示 Day 19 异常处理与响应外壳的示例文章。',
      tags: ['nestjs', 'exception'],
      status: 'published',
    });
  }
  ...
  // 给练习 1 / 4 用：故意抛非 HttpException，验证全局兜底脱敏
  triggerBoom(): never {
